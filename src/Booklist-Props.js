...
function BooklistProps() {
    return (
        <section className="booklist">
            <Book img={firstBook.img} title={firstBook.title} author={firstBook.author}><p>Dolor adipisicing occaecat qui culpa ea nulla enim excepteur nisi eu eiusmod id.</p></Book>
